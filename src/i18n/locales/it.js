export default {
  ...
  ads: {
    ...
    cta: 'Scopri di più',
    whyTitle: 'Perché vedo questo annuncio?',
    whyCopy: 'È stato selezionato usando solo il contesto generale del browser, come lingua, area e tipo di dispositivo. Non usiamo cronologia o ricerche private.',
    frequencyCap: 'Puoi vedere questa campagna al massimo {count} volte al giorno.',
    feedbackPrompt: 'È pertinente?',
    relevant: 'Pertinente',
  ...
  bookmarks: {
    ...
    newCategory: 'Nome della nuova categoria:',
    bookmarkName: 'Nome segnalibro:',
    bookmarkUrl: 'URL segnalibro:',
  ...
  weather: {
    ...
    low: 'Min',
    wind: 'Vento',
    stale: 'Visualizzazione dati in cache.',
    useCurrentLocation: 'Usa posizione attuale',
    city: 'Citta',
    cityPlaceholder: 'Cerca citta',
    apply: 'Applica',
    ...
    errors: {
      unavailable: 'Servizio meteo non disponibile.',
      noGeolocation: 'Geolocalizzazione non disponibile.',
      locationDenied: 'Impossibile ottenere la posizione.',
      cityNotFound: 'Citta non trovata.',
    },
  },
  currency: {
    ...
    to: 'A',
    rate: 'Tasso',
    stale: 'Uso dei tassi in cache.',
    loading: 'Aggiornamento tassi...',
    rateUnavailable: 'Tasso non disponibile',
    errors: {
      unavailable: 'Servizio valute non disponibile.',
    },
  },
    title: 'Temi',
  ...
  updateNotice: {
    title: 'Aggiornamento Midori disponibile',
    message: 'Una nuova versione di Midori ({version}) è pronta per il download.',
    download: 'Scarica',
