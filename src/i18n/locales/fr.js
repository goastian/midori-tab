export default {
  ...
  bookmarks: {
    ...
    bookmarkName: 'Nom du favori :',
    bookmarkUrl: 'URL du favori :',
    confirmDelete: 'Supprimer',
    searchPlaceholder: 'Rechercher des favoris...',
    export: 'Exporter',
    import: 'Importer',
    importError: 'Impossible d\'importer le fichier selectionne.',
  },
  weather: {
    title: 'Meteo',
    loading: 'Chargement des previsions...',
    high: 'Max',
    low: 'Min',
    wind: 'Vent',
    stale: 'Affichage des donnees en cache.',
    ...
    errors: {
      unavailable: 'Service meteo indisponible.',
      noGeolocation: 'Geolocalisation indisponible.',
  ...
  currency: {
    ...
    to: 'Vers',
    rate: 'Taux',
    stale: 'Utilisation de taux en cache.',
    loading: 'Mise a jour des taux...',
    rateUnavailable: 'Taux indisponible',
    errors: {
      unavailable: 'Service de devises indisponible.',
    },
  },
    title: 'Thèmes',
