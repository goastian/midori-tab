const widgetCopyByLocale = {
  en: {
    ...
    rssWidget: {
      ...
      emptyText: 'Try another country, language, or category.',
      clearFilters: 'Clear filters',
      filterFallback: 'No recent stories matched every filter. Showing the closest available results.',
  ...
  es: {
    ...
    rssWidget: {
      ...
      emptyText: 'Prueba con otro país, idioma o categoría.',
      clearFilters: 'Limpiar filtros',
      filterFallback: 'No hay noticias recientes que coincidan con todos los filtros. Mostramos los resultados disponibles más cercanos.',
