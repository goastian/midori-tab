const widgetCopyByLocale = {
  ...
  es: {
    ...
    browserBookmarks: {
      ...
      searchPlaceholder: 'Buscar marcadores del navegador...',
      loading: 'Cargando marcadores...',
      empty: 'No hay marcadores disponibles.',
    ...
    astianRssWidget: {
      ...
      loading: 'Cargando noticias de Astian...',
      retry: 'Reintentar',
      category: 'Astian',
    },
    privacyWidget: {
  ...
  pt: {
    ...
    browserBookmarks: {
      ...
      empty: 'Não há favoritos disponíveis.',
      unavailable: 'A API de favoritos não está disponível.',
    },
    rssWidget: {
      previousFeed: 'Fonte anterior',
      nextFeed: 'Próxima fonte',
    ...
    astianRssWidget: {
      title: 'Notícias da Astian',
      loading: 'Carregando notícias da Astian...',
      retry: 'Tentar novamente',
      category: 'Astian',
    },
    privacyWidget: {
  ...
  fr: {
    ...
    browserBookmarks: {
      ...
      searchPlaceholder: 'Rechercher des favoris du navigateur...',
      loading: 'Chargement des favoris...',
      empty: 'Aucun favori disponible.',
      unavailable: 'API des favoris indisponible.',
    },
    rssWidget: {
      previousFeed: 'Flux précédent',
    ...
    astianRssWidget: {
      title: 'Actualités Astian',
      loading: 'Chargement des actualités Astian...',
      retry: 'Réessayer',
      category: 'Astian',
    },
    privacyWidget: {
  ...
  de: {
    ...
    browserBookmarks: {
      ...
      empty: 'Keine Lesezeichen verfügbar.',
      unavailable: 'Lesezeichen-API nicht verfügbar.',
    },
    rssWidget: {
      previousFeed: 'Vorheriger Feed',
    ...
    astianRssWidget: {
      title: 'Astian News',
      loading: 'Astian-News werden geladen...',
      retry: 'Erneut versuchen',
      category: 'Astian',
    },
    privacyWidget: {
  ...
  ru: {
    ...
    browserBookmarks: {
      ...
      searchPlaceholder: 'Поиск закладок браузера...',
      loading: 'Загрузка закладок...',
      empty: 'Закладки недоступны.',
      unavailable: 'API закладок недоступен.',
    },
    rssWidget: {
      previousFeed: 'Предыдущий источник',
      nextFeed: 'Следующий источник',
    ...
    astianRssWidget: {
      title: 'Новости Astian',
      loading: 'Загрузка новостей Astian...',
      retry: 'Повторить',
      category: 'Astian',
    },
    privacyWidget: {
  ...
  ja: {
    ...
    browserBookmarks: {
      ...
      empty: '利用できるブックマークはありません。',
      unavailable: 'ブックマーク API は利用できません。',
    },
    rssWidget: {
      previousFeed: '前のフィード',
      nextFeed: '次のフィード',
  ...
  it: {
    ...
    browserBookmarks: {
      ...
      searchPlaceholder: 'Cerca nei segnalibri del browser...',
      loading: 'Caricamento segnalibri...',
      empty: 'Nessun segnalibro disponibile.',
      unavailable: 'API dei segnalibri non disponibile.',
    },
    rssWidget: {
      previousFeed: 'Feed precedente',
      nextFeed: 'Feed successivo',
    ...
    astianRssWidget: {
      title: 'Notizie Astian',
      loading: 'Caricamento notizie Astian...',
      retry: 'Riprova',
      category: 'Astian',
    },
    privacyWidget: {
